(function () {
  const files = [
    ...
    "homeFiveChart.js",
    "invoice.js",
    "lineChartPageChart.js",
    "columnChartPageChart.js",
    "pieChartPageChart.js",
  ];
...
function createChartTwo(chartId, color1, color2) {
  var options = {
    series: [
      {
        name: "Income",
        data: window.dashboardData.income,
      },
      {
        name: "Expenses",
        data: window.dashboardData.expenses,
      },
    ],
    legend: {
      show: false,
...
var chart = new ApexCharts(
  document.querySelector("#purchaseSaleChart"),
  options,
);
chart.render();
// ================================ Purchase & sale chart End ================================
